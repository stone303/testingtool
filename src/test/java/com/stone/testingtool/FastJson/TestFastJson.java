package com.stone.testingtool.FastJson;
...
import com.stone.testingtool.dao.Person;
...
public class TestFastJson {
    ...
    public void setUp() {
        ...
        //Calendar是一个抽象类，不能直接实例化，需要通过调用它的静态方法getInstance()来获取一个Calendar对象
        Calendar calendar = Calendar.getInstance();
        calendar.setTimeZone(TimeZone.getTimeZone("UTC")); // 设置时区为UTC
        // 设置日历  month 从0开始的
        calendar.set(2022, 01, 03);
        // 实例化Java对象
    ...
    public void whenJavaList_thanConvertToJsonCorrect() {
        ...
        Assert.assertEquals(personJsonFormat, "[{\"FIRST NAME\":\"Doe\",\"LAST NAME\":\"John\",\"DATE OF BIRTH\":"
                + "\"03/02/2022\"},{\"FIRST NAME\":\"Doe\",\"LAST NAME\":\"Janette\",\"DATE OF BIRTH\":"
                + "\"03/02/2022\"}]");
    ...
    public void givenSerializeConfig_whenJavaObject_thanJsonCorrect() {
        ...
        Assert.assertEquals(jsonOutput, "[{\"first_name\":\"Doe\",\"last_name\":\"John\","
                + "\"date_of_birth\":\"2022-02-03\"},{\"first_name\":\"Doe\",\"last_name\":"
                + "\"Janette\",\"date_of_birth\":\"2022-02-03\"}]");
    ...
    @Test(description = "使用SerializerFeature.BeanToArray生成数组")
    public void testBeanToArray() {

        String jsonOutput= JSON.toJSONString(listOfPersons, SerializerFeature.BeanToArray);
        System.out.println(jsonOutput);
        Assert.assertEquals(jsonOutput,"[[\"Doe\",\"John\",\"03/02/2022\"],[\"Doe\",\"Janette\",\"03/02/2022\"]]");
    }
